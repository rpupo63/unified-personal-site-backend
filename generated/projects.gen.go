...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.ID = field.NewField(tableName, "id")
	_project.Title = field.NewString(tableName, "title")
	_project.Description = field.NewString(tableName, "description")
	_project.GithubLink = field.NewString(tableName, "github_link")
	_project.DemoLink = field.NewString(tableName, "demo_link")
	_project.Type = field.NewString(tableName, "type")
	_project.GifLink = field.NewString(tableName, "gif_link")
	_project.Tags = projectHasManyTags{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Tags", "models.ProjectTag"),
		Project: struct {
			field.RelationField
			Tags struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Tags.Project", "models.Project"),
			Tags: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Tags.Project.Tags", "models.ProjectTag"),
			},
		},
	}
...
type project struct {
	...
	GithubLink  field.String
	DemoLink    field.String
	Type        field.String
	GifLink     field.String
	Tags        projectHasManyTags
...
func (p *project) updateTableName(table string) *project {
	...
	p.GithubLink = field.NewString(table, "github_link")
	p.DemoLink = field.NewString(table, "demo_link")
	p.Type = field.NewString(table, "type")
	p.GifLink = field.NewString(table, "gif_link")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["github_link"] = p.GithubLink
	p.fieldMap["demo_link"] = p.DemoLink
	p.fieldMap["type"] = p.Type
	p.fieldMap["gif_link"] = p.GifLink
...
type projectHasManyTags struct {
	db *gorm.DB
...
func (a projectHasManyTags) Where(conds ...field.Expr) *projectHasManyTags {
	if len(conds) == 0 {
		return &a
	}
...
func (a projectHasManyTags) WithContext(ctx context.Context) *projectHasManyTags {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a projectHasManyTags) Session(session *gorm.Session) *projectHasManyTags {
	a.db = a.db.Session(session)
	return &a
}

func (a projectHasManyTags) Model(m *models.Project) *projectHasManyTagsTx {
	return &projectHasManyTagsTx{a.db.Model(m).Association(a.Name())}
}

func (a projectHasManyTags) Unscoped() *projectHasManyTags {
	a.db = a.db.Unscoped()
	return &a
}

type projectHasManyTagsTx struct{ tx *gorm.Association }

func (a projectHasManyTagsTx) Find() (result []*models.ProjectTag, err error) {
	return result, a.tx.Find(&result)
}

func (a projectHasManyTagsTx) Append(values ...*models.ProjectTag) (err error) {
...
func (a projectHasManyTagsTx) Replace(values ...*models.ProjectTag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a projectHasManyTagsTx) Delete(values ...*models.ProjectTag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a projectHasManyTagsTx) Clear() error {
	return a.tx.Clear()
}

func (a projectHasManyTagsTx) Count() int64 {
	return a.tx.Count()
}

func (a projectHasManyTagsTx) Unscoped() *projectHasManyTagsTx {
	a.tx = a.tx.Unscoped()
	return &a
}
